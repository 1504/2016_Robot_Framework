...
public class Groundtruth implements Updatable {
	...
	/**
	 * Sets the robot's current position index. Useful for setting at the start
	 * of the match or resetting at a known point on the field.
	 * 
	 * @param p
	 *            - forward, right, and anticlockwise position values.
	 */
	 ...
	 * 
	 * @return double[] array containing: {Forward speed, Right speed,
	 *         Anticlockwise speed}
	 */
	 ...
	 * 
	 * @return double[] array containing: {Forward acceleration, Right
	 *         acceleration, Anticlockwise acceleration}
	 */
	 ...
	 * 
	 * @param data
	 *            - Data format: LEFT_X, LEFT_Y, LEFT_SQUAL, RIGHT_X, RIGHT_Y,
	 *            RIGHT_SQUAL
	 */
	...
	public void semaphore_update() {
		...
		/*
		 * if(_raw_data != null) _logger.log(Map.LOGGED_CLASSES.GROUNDTRUTH,
		 * _raw_data); _raw_data = null;
		 */
	}
}
