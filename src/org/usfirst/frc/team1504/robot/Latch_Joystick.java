...
public class Latch_Joystick extends Joystick implements Updatable {
	...
	public boolean getRawButtonLatch(final int button) {
		// Compute a clearing mask for the button. ex: 11111 - 00100 = 11011,
		// will turn off button 3
	...
	/**
	 * Synchronized with new data from the Driver Station, will update the
	 * button mask. Ensures that a button event will not be missed.
	 */
